export class CurListEntity {
    static getObjData(todayEntity, yesterdayEntity) {
        ...
        for (let i = 0; i < todayEntity.length; i++) {
            ...
            obj['Cur_OfficialRate'] = todayEntity[i]['Cur_OfficialRate'].toFixed(4);
            obj['Cur_Change'] = (todayEntity[i]['Cur_OfficialRate'] - yesterdayEntity[i]['Cur_OfficialRate']).toFixed(4);
            data.push(obj);
        }
        return data;
    }
